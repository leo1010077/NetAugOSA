...
class MCUNet(nn.Module):
    def __init__(self, channel_divisor=8, num_classes=1000, dropout_rate=0, width=0.5):
        super(MCUNet, self).__init__()
        stage_width_list = [16, 8, 16, 24, 40, 48, 96] * width
        head_width_list = [160] * width
        act_func = "relu6"
        ...
        head = OpSequential(
            [
                ...
                LinearLayer(head_width_list[0], num_classes, dropout_rate=dropout_rate),
            ]
        )
