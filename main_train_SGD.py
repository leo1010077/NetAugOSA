...
def parse_option():
    ...
    parser.add_argument('--experiment', type=str, default='0411_resnet18_quarterquarter_paddingfix_likePaper+bnfinetune', help="experiment name")
    #parser.add_argument('--experiment', type=str, default='0408_MCU_adam_1_retry_nosort',help="experiment name")
    parser.add_argument('--init_way', type=str, default='kaiming_uniform', help="kaiming_uniform or None")
    parser.add_argument('--NetAug', type=list[float], default=[1.0, 1.5, 2], help="[1] for no Aug")
    # easy config modification
    parser.add_argument('--lr', type=float, default=0.025, help="lr")
    parser.add_argument('--num_epochs', type=int, default=200, help="epoch")
