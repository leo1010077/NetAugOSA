...
def parse_option():
    ...
    parser.add_argument('--experiment', type=str, default='0409_MCU_11.522.53_1e-3_re', help="experiment name")
    parser.add_argument('--init_way', type=str, default='kaiming_uniform', help="kaiming_uniform or None")
    parser.add_argument('--NetAug', type=list[float], default=[1, 1.5, 2, 2.5, 3], help="[1] for no Aug")
