...
from Model.NetAug.ResNet18_NetAugV2_nopadding import NetAugResNet18_nopadding
from Model.base.ResNet_baseV2_nopadding import ResNet_base_nopadding
...
def parse_option():
    ...
    parser.add_argument('--experiment', type=str, default='0415_resnet18qq_resetBN', help="experiment name")
...
def test(model, aug, _resetBN, device, train_loader, test_loader, fold, result, epoch, wandb_logger=None):
    if _resetBN:
        reset_bn(model, train_loader, sync=False)
    # =========================================================
